...
public class Salary implements Serializable {
    ...
    public Salary(Integer s_id, Integer e_id, Date s_date, Integer s_performance, Integer s_extra, Integer s_reward, Integer s_s_insurance, Integer s_total, Integer s_is_trouble) {
        this.s_id = s_id;
        this.e_id = e_id;
        this.s_date = s_date;
        this.s_performance = s_performance;
