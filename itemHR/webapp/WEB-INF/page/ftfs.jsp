        ...
        $(function () {
            if (${!empty requestScope.get("flag") }) {
                if (${requestScope.get("flag") eq 0}) {
                    ...
                    $("#t2").hide(1000);
                    $("#t3").hide(1000);
                } else if (${requestScope.get("flag") eq 1}) {
                    $("#a1").css("backgroundColor","buttonface");
            ...
            <tr>
                <td colspan="4">
                    <div class="div4">
                        ...
                        <span><a href="ftfsView.do?pageNo0=1">首页</a></span>
                        <span><a href="ftfsView.do?pageNo0=<%=page0.getPrevPage()%>">上一页</a></span>
                        <span><a href="ftfsView.do?pageNo0=<%=page0.getNextPage()%>">下一页</a></span>
                        <span><a href="ftfsView.do?pageNo0=<%=page0.getTotalPage()%>">尾页</a></span>
                        <form style="size: 10px;display: inline" action="ftfsView.do"
            ...
            <tr>
                <td colspan="5">
                    <div class="div4">
                        ...
                        <span><a href="ftfsView.do?pageNo1=1">首页</a></span>
                        <span><a href="ftfsView.do?pageNo1=<%=page1.getPrevPage()%>">上一页</a></span>
                        <span><a href="ftfsView.do?pageNo1=<%=page1.getNextPage()%>">下一页</a></span>
                        <span><a href="ftfsView.do?pageNo1=<%=page1.getTotalPage()%>">尾页</a></span>
                        <form style="size: 10px;display: inline" action="ftfsView.do"
                              onsubmit="return checkNum(this.children[1].value)">
            ...
            <tr>
                <td colspan="4">
                    <div class="div4">
                        ...
                        <span><a href="ftfsView.do?pageNo3=1">首页</a></span>
                        <span><a href="ftfsView.do?pageNo3=<%=page3.getPrevPage()%>">上一页</a></span>
                        <span><a href="ftfsView.do?pageNo3=<%=page3.getNextPage()%>">下一页</a></span>
                        <span><a href="ftfsView.do?pageNo3=<%=page3.getTotalPage()%>">尾页</a></span>
                        <form style="size: 10px;display: inline" action="ftfsView.do"
                              onsubmit="return checkNum(this.children[1].value)">
